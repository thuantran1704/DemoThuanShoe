...
export const statisticProductBetweenReducer = (state = { statisticProductBetweens: [], sum : 0 }, action) => {
    switch (action.type) {
        case GET_STATISTIC_PRODUCT_BETWEEN_DATE_REQUEST:
            return { loading: true, statisticProductBetweens: [], sum : 0 }
        case GET_STATISTIC_PRODUCT_BETWEEN_DATE_SUCCESS:
            return {
                loading: false,
                statisticProductBetweens: action.payload.result,
